...
//#define EXTRUDER_OFFSET_X {0.0, 22.00} // (in mm) for each extruder, offset of the hotend on the X axis
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -1  // Y offset: -front [of the nozzle] +behind
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,155.9}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 2, 150}    // (mm/sec)
...
#define DEFAULT_ZJERK                 0.25     // (mm/sec)
